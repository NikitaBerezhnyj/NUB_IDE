 ...
 */
export interface RichTextareaProps extends Omit<JSX.IntrinsicElements["textarea"], "children"> {
    /**
     *
 ...
 */
export declare const RichTextarea: import("react").ForwardRefExoticComponent<Omit<RichTextareaProps, "ref"> & import("react").RefAttributes<RichTextareaHandle>>;
